...
const PSGETSID_PATH = path.join(__dirname, "dependencies", ARCH === "x64" ? "PsGetSid64.exe" : "PsGetSid.exe");
class Async {
    static run(options) {
            ...
            try {
                ...
                child.on("close", (code) => {
                    if (code === 0)
                        ...
                        reject(new Error(stderr || `PsGetSid exited with code ${code}`));
                });
...
//# sourceMappingURL=psgetsid.js.map